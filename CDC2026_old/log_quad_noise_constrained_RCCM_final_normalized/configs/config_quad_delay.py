...
X_MIN = np.array([-pos_b, -pos_b, -pos_b, -vel_b, -vel_b, -vel_b, g-a_b, -roll_b, -pitch_b, -yaw_b]).reshape(-1,1)
X_MAX = np.array([pos_b, pos_b, pos_b, vel_b, vel_b, vel_b, g+a_b, roll_b, pitch_b, yaw_b]).reshape(-1,1)
...
XE_MIN = np.array([-pos_err_b, -pos_err_b, -pos_err_b, -vel_err_b, -vel_err_b, -vel_err_b, -a_err_b, -euler_err_b, -euler_err_b, -euler_err_b]).reshape(-1,1)
XE_MAX = np.array([pos_err_b, pos_err_b, pos_err_b, vel_err_b, vel_err_b, vel_err_b, a_err_b, euler_err_b, euler_err_b, euler_err_b]).reshape(-1,1)
...
XE_INIT_MIN = np.array([-pos_0_err_b, -pos_0_err_b, -pos_0_err_b, -vel_0_err_b, -vel_0_err_b, -vel_0_err_b, -accel_0_err_b, -euler_0_err_b, -euler_0_err_b, -euler_0_err_b])
XE_INIT_MAX = np.array([pos_0_err_b, pos_0_err_b, pos_0_err_b, vel_0_err_b, vel_0_err_b, vel_0_err_b, accel_0_err_b, euler_0_err_b, euler_0_err_b, euler_0_err_b])
...
def system_reset(seed, trajectory_generator):
    ...
    with temp_seed(int(seed * SEED_MAX)):
        ...
        # For SO3
        Rref_0 = xref_0[7:16].reshape(3, 3)  # Initial reference attitude 
        eul_e_0 = xe_0[7:10]
        ...
        vref_0 = xref_0[0:7]  # Initial reference in vectorspace
        ve_0 = xe_0[0:7]  # Initial error in vectorspace
