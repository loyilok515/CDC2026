...
plot_type = '3D'  # '2D', '3D', 'time', 'attitude', 'error', 'control'
...
task = 'quad'
log = 'log_quad_constrained_euler' # You'll need to set this to the path of your log model
...
if __name__ == '__main__':
    ...
    if simulate or (not os.path.exists(csv_path)):
        ...
        for _ in range(nTraj):
            ...
            xstar, x, x_att, ustar, u = RK4(controller, trajectory_generator, f, B, B_w, x_0, time_bound, time_step, sigma=sigma)
