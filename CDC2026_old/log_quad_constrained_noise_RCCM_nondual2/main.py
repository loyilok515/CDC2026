...
w_ub = 20  # Upper bound of the eigenvalue of the dual metric  ### 10
w_lb = 0.05  # Lower bound of the eigenvalue of the dual metric
...
log = 'log_quad_constrained_noise_RCCM_nondual2' #'log_quad_RCCM_torque'  # Path to a directory for storing the training log
