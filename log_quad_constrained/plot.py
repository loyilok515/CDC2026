...
plot_type = 'control_error'  # '2D', '3D', 'time', 'attitude', 'error', 'control', 'control_error'
plot_dims = [1]  # For '2D', '3D', 'time' and 'error' plot types, specify which state dimensions to plot
...
save_plot_dir = os.path.join(log, 'results/plots')  # Directory to save the plot image, e.g., 'results/plots/3D_path.png'; to show the plot instead, set to None
save_csv_dir = os.path.join(log, 'results/csvs')  # Directory to save the csv files; disable with None
...
if __name__ == '__main__':
    ...
    if simulate or (not os.path.exists(csv_path)):
        ...
        for _ in range(nTraj):
            ...
            xstar, x, x_att, ustar, u = RK4(controller, trajectory_generator, f, B, B_w, x_0, time_bound, time_step, w_MIN, w_MAX)
