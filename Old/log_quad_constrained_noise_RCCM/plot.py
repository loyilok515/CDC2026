...
from utils_trajectory_generation import hover_trajectory_generator, circular_trajectory_generator, circular_delayed_trajectory_generator
import time
...
plot_dims_dict = {'2D': [0, 1], '3D': [0, 1, 2], 'time': [2], 'attitude': [0, 1, 2], \
                  'error': [0, 1, 2, 3], 'control': [1, 2, 3], 'control_error': [1, 2, 3], 'disturbance_est_err': [0, 1, 2]} # specify which state dimensions to plot
...
task = 'quad_delay'
log = 'log_quad_delay_RCCM' # You'll need to set this to the path of your log model
trajectory_generator = circular_delayed_trajectory_generator
...
if __name__ == '__main__':
    ...
    if simulate or (not os.path.exists(csv_path)):
        ...
        for _ in range(nTraj):
            ...
            xstar, x, x_att, ustar, CCM_output, u, d_hat_err = RK4(controller, trajectory_generator, UDE_activated, f, B, B_w, x_0, time_bound, time_step, w_MIN, w_MAX)
