...
# Control constraints (need to include the one in config_MUAV.py)
T_bound = 5 #10#5#7
omega_bound = 0.35 #0.4#1.5#1.2

# Control saturation factor - increased to avoid premature saturation
saturation_factor = 0.1 #0.1#0.3#0.01  # Changed from 0.01 to 0.1, further changed to 0.3
