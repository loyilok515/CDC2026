...
task = 'quad_noise'
log = 'log_quad_constrained_noise_RCCM' # You'll need to set this to the path of your log model
...
trajectory_generator = planner.circular_trajectory_generator  # hover, circular, circular_yaw_aligned
...
if __name__ == '__main__':
    ...
    if simulate or (not os.path.exists(csv_path)):
        ...
        for _ in range(nTraj):
            ...
            xstar, x, x_att, ustar, CCM_output, u, d_hat_err = RK4(controller, trajectory_generator, UDE_activated, SO3_index, f, B, B_w, x_0, time_bound, time_step, w_MIN, w_MAX)
